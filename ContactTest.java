...
class ContactTest {
	...
	@Test
	void testCreateContactContactIdFails() {													// All tests actions are well described by their own name
		  Assertions.assertThrows(IllegalArgumentException.class, () -> {						// and are tested by passing incorrect values for fail validation
			  new Contact("12345678901", "Bob", "Mike", "1111 E Road Street", "4802929112");	// and passing correct values for success validation
		    });	
	}
	...
	void testUpdateContactSuccess() {
		...
		contact.setContactLastName("Lipson");
	...
	void testUpdateContactLastNameFails() {
		Contact contact = new Contact("123456", "Bob", "Mike", "1111 E Road Street", "4802929112");	
		assertFalse(contact.setContactLastName("MikeMMMMMMM"));
	}
